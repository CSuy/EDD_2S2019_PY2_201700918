 ...
 */
public class Reporte_Grafo extends javax.swing.JFrame {

    /**
     * Creates new form Reporte_Grafo
     */
    public Reporte_Grafo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte_Grafo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte_Grafo().setVisible(true);
            }
        });
    }
    ...
    private void Cargar() {
        try{
            String ruta = "Reportes/Grafo_" + nombre_usuarior + ".jpg";
