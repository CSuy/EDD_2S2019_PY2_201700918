 ...
 */
public class Reporte_Pila extends javax.swing.JFrame {

    /**
     * Creates new form Reporte_Pila
     */
    public Reporte_Pila() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte_Pila.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte_Pila().setVisible(true);
            }
        });
    }
    ...
    private void Cargar() {
        try{
            String ruta = "Reportes/Bitacora_" + nombre_usuarior + ".jpg";
